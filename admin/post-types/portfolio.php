 ...
 */
function _rbm_portfolio_images( $post ) {

	wp_nonce_field( __FILE__, 'portfolio_images_nonce' );
	...
	<p>
		<label>
			...
			<input type="hidden" class="image-id" name="_portfolio_image_full"
	...
	<p>
		<label>
			...
			<input type="hidden" class="image-id" name="_portfolio_image_mobile"
...
add_action( 'save_post', function ( $post_ID ) {
	...
	if ( ! wp_verify_nonce( $_POST['portfolio_images_nonce'], __FILE__ ) ) {
		return;
	}
	...
	$options = array(
		'_portfolio_image_full',
		'_portfolio_image_mobile',
	);
